...
export class AdminUserService {
    ...
    getAllAdminUsers(rowsOnPage, activePage, sortTrem, search = '', roles = 'A') {
    ...
    getRoles() {
        ...
        headers.append('Authorization', this._accessToken);
        return this._http.get(this._host +'/roles?sort=name', { headers: headers }).map((res:Response) => res.json())
    }
